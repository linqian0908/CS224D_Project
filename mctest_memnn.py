...
from data_utils.theano_util import *
    ...
    def __init__(self, n_words=20, n_embedding=100, lr=0.01,
        ...
        self.train_function = theano.function(
            inputs = [
                ...
                theano.In(variable=l_rate, value=self.lr),
                theano.In(variable=zero_vector, value=np.zeros((self.n_embedding,), theano.config.floatX))
            ],
            outputs = cost,
            updates = updates,
...
if __name__ == "__main__":
    ...
    if train_my_model:
        ...
        for i in xrange(n_epochs/5):
            ...
            wmemNN.predict(test_dataset, test_questions, test_max_words, print_errors=True)
